import {Row, Col, Radio, Button, message, Table, Space} from 'antd'
...
export class AdminOrderDetail extends React.Component {
    ...
    onBack(){
        // 页面跳转
        this.props.history.push({ pathname: "/adminOrder" })
    }
    render(){
        return(
            <div>
